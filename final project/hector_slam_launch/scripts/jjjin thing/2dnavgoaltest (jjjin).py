...
def send_goal1():
    ...
    goal.pose.position.x = 1.9047364096314259
    goal.pose.position.y = 0.2620673025616582
    goal.pose.position.z = 0.0

    # Set orientation based on the target data provided
    goal.pose.orientation.x = 0.0
    goal.pose.orientation.y = 0.0
    goal.pose.orientation.z = -0.019593137736262766
    goal.pose.orientation.w = 0.9998080360517452
...
def send_goal2():
    ...
    goal.pose.position.x = 1.918037890391474
    goal.pose.position.y = -0.06179979234769145
    goal.pose.position.z = 0.0

    # Set orientation based on the new target data provided
    goal.pose.orientation.x = 0.0
    goal.pose.orientation.y = 0.0
    goal.pose.orientation.z = 0.0048937493486821354
    goal.pose.orientation.w = 0.9999880255369622
