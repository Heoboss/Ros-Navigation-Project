...
def send_goal1():
    ...
    goal.pose.position.x = 1.7922241791599385
    goal.pose.position.y = 0.2989799157215695
    goal.pose.position.z = 0.0

    # Set orientation based on the target data provided
    goal.pose.orientation.x = 0.0
    goal.pose.orientation.y = 0.0
    goal.pose.orientation.z = -0.0104130705390282
    goal.pose.orientation.w = 0.9999457825112066
...
def send_goal2():
    ...
    goal.pose.position.x = 1.8296398613351939
    goal.pose.position.y = -0.06786394976565818
    goal.pose.position.z = 0.0

    # Set orientation based on the new target data provided
    goal.pose.orientation.x = 0.0
    goal.pose.orientation.y = 0.0
    goal.pose.orientation.z = -4.13298228957567e-05
    goal.pose.orientation.w = 0.9999999991459229
